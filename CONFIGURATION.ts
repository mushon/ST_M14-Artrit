export const AIRTABLE_BASE = 'appowVryh3gfUSkbN';
export const AIRTABLE_API_KEY = 'keysQhZVOtQlTCtZP';
export const AIRTABLE_DETAILS_FORM = 'https://airtable.com/shrQYzUght6QWpzs2';
